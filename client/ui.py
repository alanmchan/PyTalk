...
class UILogin(UI):
    ...
    def login(self):
        '''生成登录界面'''
        tk.Label(self.root, text='Welcome to PyTalk', font=('微软雅黑', 16)).grid(row=0, column=0, columnspan=3)
        tk.Label(self.root, text="用户名：").grid(row=1, column=0, padx=10, pady=10)
        tk.Label(self.root, text="密  码：").grid(row=2, column=0, padx=10, pady=10)
        ...
        self.btn_register = tk.Button(self.root, text='Register', command=self.do_register)
        self.btn_register.grid(row=3, column=0, padx=10, pady=10)
        self.btn_login = tk.Button(self.root, text='Login', command=self.do_login)
        self.btn_login.grid(row=3, column=1, padx=10, pady=10)
        self.btn_quit = tk.Button(self.root, text='Cancel', command=self.root.quit, fg='red')
